...
class MessagesViewController: MSMessagesAppViewController {
    ...
    func composeSelectionMsg(in session: MSSession, link: String, voice: String, tts: String) -> MSMessage {
        ...
        let layout = MSMessageLiveLayout(alternateLayout: MSMessageTemplateLayout())
        layout.alternateLayout.caption = "Voice(DeepFake): "+voice
        layout.alternateLayout.subcaption = "Transcript: " + tts
        layout.alternateLayout.image = UIImage(named: "AltImage")
        
        let message = MSMessage(session: session)
        message.layout = layout
        message.summaryText = "Mock'EM Message: " + tts
